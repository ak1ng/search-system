  ...
  App.speechCommand('go to',{
    ...
    listen: function(datos){
      switch(datos){
        ...
        case "login": location.href = "pages-login.jsp?listen=on"; break;
        case "404 page": location.href = "404.jsp?listen=on"; break;
        case "500 page": location.href = "500.jsp?listen=on"; break;
        case "500 page": location.href = "500.jsp?listen=on"; break;
        default:
