...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.gritter/css/jquery.gritter.css" />

    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.nanoscroller/nanoscroller.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.easypiechart/jquery.easy-pie-chart.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/bootstrap.switch/bootstrap-switch.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/bootstrap.datetimepicker/css/bootstrap-datetimepicker.min.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.select2/select2.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/bootstrap.slider/css/slider.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/intro.js/introjs.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.vectormaps/jquery-jvectormap-1.2.2.css" media="screen"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.magnific-popup/dist/magnific-popup.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/jquery.niftymodals/css/component.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>js/bootstrap.summernote/dist/summernote.css" />
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                <li class="dropdown profile_menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="<%=basePath%>images/avatar2.jpg" /><span>Jeff Hanneman</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                            ...
                            <div class="nano nscroller">
                                <div class="content">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <img src="<%=basePath%>images/avatar2.jpg" alt="avatar" /><span class="date pull-right">13 Sept.</span> <span class="name">Daniel</span> I'm following you, and I want your money!
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="<%=basePath%>images/avatar_50.jpg" alt="avatar" /><span class="date pull-right">20 Oct.</span><span class="name">Adam</span> is now following you
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="<%=basePath%>images/avatar4_50.jpg" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Michael</span> is now following you
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="<%=basePath%>images/avatar3_50.jpg" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Lucy</span> is now following you
                                            </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <div class="cl-sidebar" data-position="right" data-step="1" data-intro="<strong>Fixed Sidebar</strong> <br/> It adjust to your needs." >
        ...
        <div class="cl-navblock">
            <div class="menu-space">
                <div class="content">
                    <div class="side-user">
                        <div class="avatar"><img src="<%=basePath%>images/avatar1_50.jpg" alt="Avatar" /></div>
                        <div class="info">
                            <a href="#">Jeff Hanneman</a>
                            <img src="<%=basePath%>images/state_online.png" alt="Status" /> <span>Online</span>
                        </div>
                    </div>

                    <!--菜单-->
                    <ul class="cl-vnavigation">
                        <li><span>More themes</span></li>
                        <li>
                    ...
                    <ul class="timeline">
                        ...
                        <li>
                            ...
                            <div class="content">
                                ...
                                <a class="image-zoom" href="<%=basePath%>images/gallery/img4.jpg"><img src="<%=basePath%>images/gallery/img4.jpg" class="img-thumbnail" style="height:64px;" /></a>
                                <a class="image-zoom" href="<%=basePath%>images/gallery/img6.jpg"><img src="<%=basePath%>images/gallery/img6.jpg" class="img-thumbnail" style="height:64px;" /></a>
                            </div>
                        </li>
                        <li>
                        ...
                        <div class="content">
                            <div class="list-group tickets">
                                <li class="list-group-item" href="#">
                                    <span class="label label-primary pull-right">Normal</span> <img class="avatar" src="<%=basePath%>images/avatar_50.jpg"/>
                                    <h4 class="name">Jeff Hanneman</h4>
                                    <p>My vMaps plugin doesn't work</p>
                                    <span class="date">17 Feb</span>
                                </li>
                                <li class="list-group-item" href="#">
                                    <span class="label label-danger pull-right">Urgent</span> <img class="avatar" src="<%=basePath%>images/avatar4_50.jpg"/>
                                    <h4 class="name">Jhon Doe</h4>
                                    <p>My vMaps plugin doesn't work</p>
                                    <span class="date">15 Feb</span>
                                </li>
                                <li class="list-group-item" href="#">
                                    <span class="label label-warning pull-right">Medium</span> <img class="avatar" src="<%=basePath%>images/avatar1_50.jpg"/>
...
<script type="text/javascript" src="<%=basePath%>js/jquery.gritter/js/jquery.gritter.js"></script>

<script type="text/javascript" src="<%=basePath%>js/jquery.nanoscroller/jquery.nanoscroller.js"></script>
<script type="text/javascript" src="<%=basePath%>js/behaviour/general.js"></script>
<script src="<%=basePath%>js/jquery.ui/jquery-ui.js" type="text/javascript"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.sparkline/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.easypiechart/jquery.easy-pie-chart.js"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.nestable/jquery.nestable.js"></script>
<script type="text/javascript" src="<%=basePath%>js/bootstrap.switch/bootstrap-switch.min.js"></script>
<script type="text/javascript" src="<%=basePath%>js/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script src="<%=basePath%>js/jquery.select2/select2.min.js" type="text/javascript"></script>
<script src="<%=basePath%>js/skycons/skycons.js" type="text/javascript"></script>
<script src="<%=basePath%>js/bootstrap.slider/js/bootstrap-slider.js" type="text/javascript"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.niftymodals/js/jquery.modalEffects.js"></script>
<script type="text/javascript" src="<%=basePath%>js/bootstrap.summernote/dist/summernote.min.js"></script>

<script src="<%=basePath%>js/jquery.vectormaps/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-us-merc-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-world-mill-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-fr-merc-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-uk-mill-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-us-il-chicago-mill-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-au-mill-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-in-mill-en.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-map.js"></script>
<script src="<%=basePath%>js/jquery.vectormaps/maps/jquery-jvectormap-ca-lcc-en.js"></script>
...
<script type="text/javascript" src="<%=basePath%>js/jquery.magnific-popup/dist/jquery.magnific-popup.min.js"></script>
...
<script type="text/javascript" src="<%=basePath%>js/jquery.flot/jquery.flot.js"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.flot/jquery.flot.pie.js"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.flot/jquery.flot.resize.js"></script>
<script type="text/javascript" src="<%=basePath%>js/jquery.flot/jquery.flot.labels.js"></script>
</body>
</html>
